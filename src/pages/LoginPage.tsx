...
const LoginPage = ({ message }: LoginPageProps) => {
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center flex-col gap-4 dark:bg-black dark:text-white">
      <div className="w-full p-2 text-2xl bg-white shadow-sm font-bold tracking-tighter capitalize fixed top-0 flex items-start dark:bg-slate-950 dark:text-white cursor-pointer">
